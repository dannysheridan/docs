...
- Documentation content - use your `llms-full.txt` file ([example](https://docs.vapi.ai/llms-full.txt)), available out-of-box on [Fern](https://www.buildwithfern.com/) or [Mintlify](https://www.mintlify.com/).
